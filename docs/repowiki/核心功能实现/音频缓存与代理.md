...
示例: id=1234, key="lxmusic_kg_550109760"
  → cache_dir/12/0/1234.lxmusic_kg_550109760.mp3
```
...
| 歌曲来源 | key 计算方式 | 示例 |
|----------|-------------|------|
| 插件来源（有 `plugin_entry_path` + `dedup_key`） | `sanitize(plugin + "_" + dedup_key)` | `lxmusic_kg_550109760` |
