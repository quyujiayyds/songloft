...
- [internal/models/models.go](file://internal/models/models.go) -- 所有领域模型、DTO、验证逻辑与自定义序列化
- [internal/models/backup.go](file://internal/models/backup.go) -- 备份/恢复数据模型
- [internal/models/lyric.go](file://internal/models/lyric.go) -- 歌词载荷模型与序列化
- [internal/models/constant.go](file://internal/models/constant.go) -- 分页常量
- [internal/database/sqlc/models.go](file://internal/database/sqlc/models.go) -- sqlc 生成的数据库行映射模型
- [internal/database/migrations/0001_init.sql](file://internal/database/migrations/0001_init.sql) -- 初始 schema（6 张表 + 索引 + 触发器 + 预置数据）
- [internal/database/migrations/0005_lyric_source_manual.sql](file://internal/database/migrations/0005_lyric_source_manual.sql) -- lyric_source 新增 manual
- [internal/database/migrations/0007_songs_year_genre.sql](file://internal/database/migrations/0007_songs_year_genre.sql) -- 新增 year/genre 列
- [internal/database/migrations/0008_songs_fingerprint.sql](file://internal/database/migrations/0008_songs_fingerprint.sql) -- 新增 fingerprint 列
...
当前 schema 共 **6 张表**：`songs`、`playlists`、`playlist_songs`、`configs`、`auth_tokens`、`js_plugins`，通过 13 个迁移文件从初始版本演进到当前状态。所有表的 `updated_at` 列均由 SQLite TRIGGER 自动维护。

**章节来源**
- [internal/database/migrations/0001_init.sql:1-190](file://internal/database/migrations/0001_init.sql#L1-L190) -- 完整初始 schema
...
**图表来源**
- [internal/database/migrations/0001_init.sql:3-103](file://internal/database/migrations/0001_init.sql#L3-L103) -- 表定义
...
Song 是系统最核心的模型，包含 **27 个持久化字段 + 3 个运行时计算字段**，承载本地歌曲、网络歌曲和电台三种业务形态。类型由 `CHECK(type IN ('local', 'remote', 'radio'))` 约束。
...
**基础信息**：`id`(PK), `type`, `title`, `artist`, `album`, `year`(0007), `genre`(0007), `duration`

**文件与音频**：`file_path`, `url`, `file_size`, `format`, `bit_rate`, `sample_rate`, `is_live`
...
**章节来源**
- [internal/models/models.go:69-101](file://internal/models/models.go#L69-L101) -- Song 结构体
...
**章节来源**
- [internal/models/models.go:108-139](file://internal/models/models.go#L108-L139) -- PlaybackURL 与 IsHLSStream
...
**章节来源**
- [internal/models/models.go:143-168](file://internal/models/models.go#L143-L168) -- URL 生成逻辑
...
**章节来源**
- [internal/database/migrations/0001_init.sql:122](file://internal/database/migrations/0001_init.sql#L122) -- dedup_key 索引
...
**章节来源**
- [internal/models/models.go:253-303](file://internal/models/models.go#L253-L303) -- Playlist 结构体与 CanAddSong
- [internal/database/migrations/0001_init.sql:163-166](file://internal/database/migrations/0001_init.sql#L163-L166) -- 预置歌单
...
- [internal/database/migrations/0001_init.sql:45-55](file://internal/database/migrations/0001_init.sql#L45-L55) -- 表约束
...
**章节来源**
- [internal/models/models.go:329-345](file://internal/models/models.go#L329-L345) -- Config 结构体
- [internal/database/migrations/0001_init.sql:169-178](file://internal/database/migrations/0001_init.sql#L169-L178) -- 预置数据
...
**章节来源**
- [internal/models/models.go:417-439](file://internal/models/models.go#L417-L439) -- AuthToken 与 TokenInfo
- [internal/database/migrations/0001_init.sql:67-78](file://internal/database/migrations/0001_init.sql#L67-L78) -- 表定义
...
| `permissions` | JSON 数组，如 `["network","storage","fs:music"]` |
...
**章节来源**
- [internal/models/models.go:509-543](file://internal/models/models.go#L509-L543) -- JSPlugin 结构体与状态枚举
- [internal/database/migrations/0001_init.sql:81-103](file://internal/database/migrations/0001_init.sql#L81-L103) -- js_plugins 表
...
**章节来源**
- [internal/models/lyric.go:13-79](file://internal/models/lyric.go#L13-L79) -- LyricPayload 完整实现
- [internal/models/models.go:27-33](file://internal/models/models.go#L27-L33) -- 来源常量
...
**章节来源**
- [internal/models/backup.go:1-47](file://internal/models/backup.go#L1-L47) -- 备份模型
...
**章节来源**
- [internal/models/models.go:348-507](file://internal/models/models.go#L348-L507) -- DTO 定义
...
**图表来源**
- [internal/models/models.go](file://internal/models/models.go) -- 领域模型
- [internal/models/lyric.go](file://internal/models/lyric.go) -- 歌词模型
- [internal/models/backup.go](file://internal/models/backup.go) -- 备份模型
