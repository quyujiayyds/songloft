...
- [internal/app/routers.go](file://internal/app/routers.go) -- 中间件栈装配与路由注册
- [internal/app/compress.go](file://internal/app/compress.go) -- 预压缩静态资源服务
- [internal/app/access_log.go](file://internal/app/access_log.go) -- slog 访问日志桥接
- [internal/middleware/auth.go](file://internal/middleware/auth.go) -- JWT 认证中间件
- [internal/httputil/proxy.go](file://internal/httputil/proxy.go) -- 全局 HTTP 代理
- [internal/httputil/basicauth.go](file://internal/httputil/basicauth.go) -- URL 嵌入凭证提取
- [internal/services/whitelist.go](file://internal/services/whitelist.go) -- SSRF 防护白名单
...
**章节来源**
- [internal/app/routers.go:237-349](file://internal/app/routers.go#L237-L349) -- `setupBaseRouter` 中间件注册顺序
...
**章节来源**
- [internal/app/routers.go:239-249](file://internal/app/routers.go#L239-L249) -- Compress 中间件注册与 MIME 类型列表
- [internal/app/compress.go:32-78](file://internal/app/compress.go#L32-L78) -- `newPrecompressedFS` 加载逻辑
- [internal/app/compress.go:106-146](file://internal/app/compress.go#L106-L146) -- `serve` 方法：编码协商与 ETag
...
**章节来源**
- [internal/app/access_log.go:1-49](file://internal/app/access_log.go#L1-L49) -- 完整实现
...
**章节来源**
- [internal/app/routers.go:255-275](file://internal/app/routers.go#L255-L275) -- Tracely 上报 + Recoverer 注册
...
**章节来源**
- [internal/app/routers.go:279-337](file://internal/app/routers.go#L279-L337) -- CORS 中间件完整配置
...
**章节来源**
- [internal/middleware/auth.go:23-26](file://internal/middleware/auth.go#L23-L26) -- `PublicPathChecker` 接口定义
- [internal/middleware/auth.go:28-88](file://internal/middleware/auth.go#L28-L88) -- `AuthMiddleware` 完整实现
...
**章节来源**
- [internal/httputil/proxy.go:1-84](file://internal/httputil/proxy.go#L1-L84) -- 全局代理完整实现
- [internal/httputil/basicauth.go:1-15](file://internal/httputil/basicauth.go#L1-L15) -- URL 凭证提取
